...
def reaf_yaml_file(file_path:str)->dict:
    pass

def write_yaml_file(file_path : str,content:object,replace:bool = False) ->None:
    pass
def load_object(file_path :str)->object:
    logging.info("Entered the load object method from utility functions")

    try:
        with open(file_path,"rb") as file_obj:
            obj = dill.load(file_obj)
        logging.info("Exited the load_object method from utility")
